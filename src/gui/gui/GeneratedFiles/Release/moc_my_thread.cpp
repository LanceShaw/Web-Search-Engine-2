...
QT_MOC_LITERAL(1, 10, 12), // "threadFinish"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "My_Thread\0threadFinish\0"
};
...
void My_Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&My_Thread::threadFinish)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject My_Thread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_My_Thread.data,
